...
const privacyTexts: Record<string, PrivacyTextContent> = {
  en: {
    ...
    p7Header: 'ARTICLE VII — WEBSITE ANALYTICS, IP ADDRESS & TRAFFIC SOURCE LOGGING',
    p7Text: 'This website, as distinct from the on-premise ShadowVerse deployment, logs technical connection data for each visit: IP address, network operator and ASN, the approximate city and country derived from that address, browser user agent, language, screen size, referring URL, landing page and advertising campaign parameters. This is processed as legitimate use for security, fraud prevention and marketing attribution, retained for 90 days and then automatically deleted. Google Analytics 4 measures aggregate traffic only; IP addresses are never transmitted to Google or any other third party. To obtain a summary of, or to erase, this data, contact the Data Protection Officer or use the DPDP Portal.',
  ...
  hi: {
    ...
    p7Header: 'अनुच्छेद VII — वेबसाइट एनालिटिक्स, आईपी पता एवं ट्रैफ़िक स्रोत लॉगिंग',
    p7Text: 'यह वेबसाइट (ऑन-प्रेमिस शैडोवर्स सिस्टम से अलग) प्रत्येक विज़िट के लिए तकनीकी कनेक्शन डेटा दर्ज करती है: आईपी पता, नेटवर्क ऑपरेटर एवं ASN, उससे अनुमानित शहर एवं देश, ब्राउज़र, भाषा, स्क्रीन आकार, रेफ़रिंग URL, लैंडिंग पेज एवं विज्ञापन अभियान पैरामीटर। यह सुरक्षा, धोखाधड़ी रोकथाम एवं मार्केटिंग एट्रिब्यूशन हेतु वैध उपयोग के अंतर्गत संसाधित होता है, 90 दिनों तक रखा जाता है और फिर स्वतः हटा दिया जाता है। Google Analytics 4 केवल सामूहिक ट्रैफ़िक मापता है; आईपी पते Google या किसी तीसरे पक्ष को कभी नहीं भेजे जाते। इस डेटा का विवरण प्राप्त करने या उसे मिटाने हेतु DPO से संपर्क करें या DPDP पोर्टल का उपयोग करें।',
  ...
  ta: {
    ...
    p7Header: 'பிரிவு VII — இணையதள பகுப்பாய்வு, IP முகவரி மற்றும் வருகை மூல பதிவு',
    p7Text: 'இந்த இணையதளம் (ஆன்-பிரமிஸ் ShadowVerse அமைப்பிலிருந்து வேறுபட்டது) ஒவ்வொரு வருகைக்கும் தொழில்நுட்பத் தரவைப் பதிவு செய்கிறது: IP முகவரி, நெட்வொர்க் நிறுவனம் மற்றும் ASN, அதிலிருந்து பெறப்பட்ட தோராயமான நகரம் மற்றும் நாடு, உலாவி, மொழி, திரை அளவு, பரிந்துரைத்த URL, தரையிறங்கும் பக்கம் மற்றும் விளம்பரப் பிரச்சாரத் தகவல். இது பாதுகாப்பு, மோசடி தடுப்பு மற்றும் சந்தைப்படுத்தல் பகுப்பாய்விற்காக நியாயமான பயன்பாட்டின் கீழ் செயலாக்கப்பட்டு, 90 நாட்கள் வைக்கப்பட்டு பின்னர் தானாக அழிக்கப்படுகிறது. Google Analytics 4 மொத்த போக்குவரத்தை மட்டுமே அளவிடுகிறது; IP முகவரிகள் Google அல்லது வேறு எந்த மூன்றாம் தரப்பினருக்கும் அனுப்பப்படுவதில்லை. இத்தரவின் சுருக்கம் பெறவோ அழிக்கவோ DPO-வைத் தொடர்பு கொள்ளவும் அல்லது DPDP போர்ட்டலைப் பயன்படுத்தவும்.',
  ...
  te: {
    ...
    p7Header: 'ఆర్టికల్ VII — వెబ్\u200cసైట్ అనలిటిక్స్, IP చిరునామా మరియు ట్రాఫిక్ మూల లాగింగ్',
    p7Text: 'ఈ వెబ్\u200cసైట్ (ఆన్-ప్రెమిస్ ShadowVerse వ్యవస్థకు భిన్నంగా) ప్రతి సందర్శనకు సాంకేతిక కనెక్షన్ డేటాను నమోదు చేస్తుంది: IP చిరునామా, నెట్\u200cవర్క్ ఆపరేటర్ మరియు ASN, దాని నుండి పొందిన సుమారు నగరం మరియు దేశం, బ్రౌజర్, భాష, స్క్రీన్ పరిమాణం, రెఫరింగ్ URL, ల్యాండింగ్ పేజీ మరియు ప్రకటన ప్రచార పారామితులు. ఇది భద్రత, మోసం నివారణ మరియు మార్కెటింగ్ అట్రిబ్యూషన్ కోసం చట్టబద్ధ వినియోగం కింద ప్రాసెస్ చేయబడి, 90 రోజులు ఉంచబడి తర్వాత స్వయంచాలకంగా తొలగించబడుతుంది. Google Analytics 4 మొత్తం ట్రాఫిక్\u200cను మాత్రమే కొలుస్తుంది; IP చిరునామాలు Googleకు లేదా ఏ మూడవ పక్షానికి ఎప్పుడూ పంపబడవు. ఈ డేటా సారాంశం పొందడానికి లేదా తొలగించడానికి DPOను సంప్రదించండి లేదా DPDP పోర్టల్ ఉపయోగించండి.',
  ...
  kn: {
    ...
    p7Header: 'ಅನುಚ್ಛೇದ VII — ವೆಬ್\u200cಸೈಟ್ ಅನಾಲಿಟಿಕ್ಸ್, IP ವಿಳಾಸ ಮತ್ತು ಸಂಚಾರ ಮೂಲ ದಾಖಲೆ',
    p7Text: 'ಈ ವೆಬ್\u200cಸೈಟ್ (ಆನ್-ಪ್ರೆಮಿಸ್ ShadowVerse ವ್ಯವಸ್ಥೆಗಿಂತ ಭಿನ್ನ) ಪ್ರತಿ ಭೇಟಿಗೆ ತಾಂತ್ರಿಕ ಸಂಪರ್ಕ ದತ್ತಾಂಶವನ್ನು ದಾಖಲಿಸುತ್ತದೆ: IP ವಿಳಾಸ, ನೆಟ್\u200cವರ್ಕ್ ಆಪರೇಟರ್ ಮತ್ತು ASN, ಅದರಿಂದ ಪಡೆದ ಅಂದಾಜು ನಗರ ಮತ್ತು ದೇಶ, ಬ್ರೌಸರ್, ಭಾಷೆ, ಪರದೆ ಗಾತ್ರ, ರೆಫರಿಂಗ್ URL, ಲ್ಯಾಂಡಿಂಗ್ ಪುಟ ಮತ್ತು ಜಾಹೀರಾತು ಅಭಿಯಾನದ ನಿಯತಾಂಕಗಳು. ಇದನ್ನು ಭದ್ರತೆ, ವಂಚನೆ ತಡೆ ಮತ್ತು ಮಾರ್ಕೆಟಿಂಗ್ ಅಟ್ರಿಬ್ಯೂಷನ್\u200cಗಾಗಿ ಕಾನೂನುಬದ್ಧ ಬಳಕೆಯಡಿ ಸಂಸ್ಕರಿಸಲಾಗುತ್ತದೆ, 90 ದಿನಗಳ ಕಾಲ ಇರಿಸಿ ನಂತರ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಅಳಿಸಲಾಗುತ್ತದೆ. Google Analytics 4 ಒಟ್ಟು ಸಂಚಾರವನ್ನು ಮಾತ್ರ ಅಳೆಯುತ್ತದೆ; IP ವಿಳಾಸಗಳನ್ನು Google ಅಥವಾ ಯಾವುದೇ ಮೂರನೇ ಪಕ್ಷಕ್ಕೆ ಎಂದಿಗೂ ಕಳುಹಿಸಲಾಗುವುದಿಲ್ಲ. ಈ ದತ್ತಾಂಶದ ಸಾರಾಂಶ ಪಡೆಯಲು ಅಥವಾ ಅಳಿಸಲು DPO ಸಂಪರ್ಕಿಸಿ ಅಥವಾ DPDP ಪೋರ್ಟಲ್ ಬಳಸಿ.',
  ...
  ml: {
    ...
    p7Header: 'അനുച്ഛേദം VII — വെബ്\u200cസൈറ്റ് അനലിറ്റിക്\u200cസ്, IP വിലാസം, ട്രാഫിക് ഉറവിട രേഖപ്പെടുത്തൽ',
    p7Text: 'ഈ വെബ്\u200cസൈറ്റ് (ഓൺ-പ്രെമിസ് ShadowVerse സംവിധാനത്തിൽ നിന്ന് വ്യത്യസ്തം) ഓരോ സന്ദർശനത്തിനും സാങ്കേതിക കണക്ഷൻ വിവരങ്ങൾ രേഖപ്പെടുത്തുന്നു: IP വിലാസം, നെറ്റ്\u200cവർക്ക് ഓപ്പറേറ്ററും ASN-ഉം, അതിൽ നിന്ന് ലഭിക്കുന്ന ഏകദേശ നഗരവും രാജ്യവും, ബ്രൗസർ, ഭാഷ, സ്\u200cക്രീൻ വലുപ്പം, റഫറിംഗ് URL, ലാൻഡിംഗ് പേജ്, പരസ്യ കാമ്പെയ്ൻ പാരാമീറ്ററുകൾ. സുരക്ഷ, തട്ടിപ്പ് തടയൽ, മാർക്കറ്റിംഗ് ആട്രിബ്യൂഷൻ എന്നിവയ്ക്കായി നിയമാനുസൃത ഉപയോഗത്തിന് കീഴിൽ ഇത് പ്രോസസ് ചെയ്യുകയും 90 ദിവസം സൂക്ഷിച്ച ശേഷം സ്വയമേവ ഇല്ലാതാക്കുകയും ചെയ്യുന്നു. Google Analytics 4 മൊത്തം ട്രാഫിക് മാത്രം അളക്കുന്നു; IP വിലാസങ്ങൾ Google-നോ മറ്റേതെങ്കിലും മൂന്നാം കക്ഷിക്കോ ഒരിക്കലും കൈമാറുന്നില്ല. ഈ വിവരങ്ങളുടെ സംഗ്രഹം ലഭിക്കാനോ മായ്ക്കാനോ DPO-യെ ബന്ധപ്പെടുക അല്ലെങ്കിൽ DPDP പോർട്ടൽ ഉപയോഗിക്കുക.',
  ...
  mr: {
    ...
    p7Header: 'अनुच्छेद VII — वेबसाइट विश्लेषण, आयपी पत्ता व रहदारी स्रोत नोंद',
    p7Text: 'ही वेबसाइट (ऑन-प्रिमाइस ShadowVerse प्रणालीपेक्षा वेगळी) प्रत्येक भेटीसाठी तांत्रिक कनेक्शन डेटा नोंदवते: आयपी पत्ता, नेटवर्क ऑपरेटर व ASN, त्यावरून काढलेले अंदाजे शहर व देश, ब्राउझर, भाषा, स्क्रीन आकार, संदर्भ URL, लँडिंग पृष्ठ व जाहिरात मोहीम मापदंड. हे सुरक्षा, फसवणूक प्रतिबंध व विपणन श्रेयनिर्धारणासाठी वैध वापराअंतर्गत प्रक्रिया केले जाते, 90 दिवस ठेवले जाते आणि नंतर आपोआप हटवले जाते. Google Analytics 4 केवळ एकत्रित रहदारी मोजते; आयपी पत्ते Google किंवा कोणत्याही तृतीय पक्षाला कधीही पाठवले जात नाहीत. या डेटाचा सारांश मिळवण्यासाठी किंवा तो पुसण्यासाठी DPO शी संपर्क साधा किंवा DPDP पोर्टल वापरा.',
  ...
  gu: {
    ...
    p7Header: 'અનુચ્છેદ VII — વેબસાઇટ એનાલિટિક્સ, IP સરનામું અને ટ્રાફિક સ્રોત નોંધણી',
    p7Text: 'આ વેબસાઇટ (ઓન-પ્રિમાઇસ ShadowVerse સિસ્ટમથી અલગ) દરેક મુલાકાત માટે તકનીકી કનેક્શન ડેટા નોંધે છે: IP સરનામું, નેટવર્ક ઓપરેટર અને ASN, તેમાંથી મેળવેલ અંદાજિત શહેર અને દેશ, બ્રાઉઝર, ભાષા, સ્ક્રીન કદ, રેફરિંગ URL, લેન્ડિંગ પેજ અને જાહેરાત ઝુંબેશ પરિમાણો. આ સુરક્ષા, છેતરપિંડી નિવારણ અને માર્કેટિંગ એટ્રિબ્યુશન માટે કાયદેસર ઉપયોગ હેઠળ પ્રક્રિયા થાય છે, 90 દિવસ રાખવામાં આવે છે અને પછી આપોઆપ કાઢી નાખવામાં આવે છે. Google Analytics 4 માત્ર કુલ ટ્રાફિક માપે છે; IP સરનામાં Google કે અન્ય કોઈ ત્રીજા પક્ષને ક્યારેય મોકલવામાં આવતાં નથી. આ ડેટાનો સારાંશ મેળવવા કે ભૂંસવા DPO નો સંપર્ક કરો અથવા DPDP પોર્ટલ વાપરો.',
  ...
  bn: {
    ...
    p7Header: 'অনুচ্ছেদ VII — ওয়েবসাইট অ্যানালিটিক্স, আইপি ঠিকানা ও ট্রাফিক উৎস নথিভুক্তি',
    p7Text: 'এই ওয়েবসাইট (অন-প্রিমিস ShadowVerse ব্যবস্থা থেকে আলাদা) প্রতিটি ভিজিটের জন্য কারিগরি সংযোগ তথ্য নথিভুক্ত করে: আইপি ঠিকানা, নেটওয়ার্ক অপারেটর ও ASN, তা থেকে প্রাপ্ত আনুমানিক শহর ও দেশ, ব্রাউজার, ভাষা, স্ক্রিনের আকার, রেফারিং URL, ল্যান্ডিং পেজ ও বিজ্ঞাপন প্রচারের প্যারামিটার। এটি নিরাপত্তা, প্রতারণা প্রতিরোধ ও বিপণন অ্যাট্রিবিউশনের জন্য বৈধ ব্যবহারের অধীনে প্রক্রিয়াকৃত হয়, ৯০ দিন রাখা হয় ও পরে স্বয়ংক্রিয়ভাবে মুছে ফেলা হয়। Google Analytics 4 কেবল সামগ্রিক ট্রাফিক পরিমাপ করে; আইপি ঠিকানা Google বা অন্য কোনো তৃতীয় পক্ষকে কখনও পাঠানো হয় না। এই তথ্যের সারসংক্ষেপ পেতে বা মুছতে DPO-র সঙ্গে যোগাযোগ করুন অথবা DPDP পোর্টাল ব্যবহার করুন।',
  ...
  pa: {
    ...
    p7Header: 'ਧਾਰਾ VII — ਵੈੱਬਸਾਈਟ ਵਿਸ਼ਲੇਸ਼ਣ, IP ਪਤਾ ਅਤੇ ਟ੍ਰੈਫਿਕ ਸਰੋਤ ਰਿਕਾਰਡਿੰਗ',
    p7Text: 'ਇਹ ਵੈੱਬਸਾਈਟ (ਆਨ-ਪ੍ਰੀਮਿਸ ShadowVerse ਸਿਸਟਮ ਤੋਂ ਵੱਖਰੀ) ਹਰ ਵਿਜ਼ਿਟ ਲਈ ਤਕਨੀਕੀ ਕਨੈਕਸ਼ਨ ਡਾਟਾ ਦਰਜ ਕਰਦੀ ਹੈ: IP ਪਤਾ, ਨੈੱਟਵਰਕ ਆਪਰੇਟਰ ਅਤੇ ASN, ਉਸ ਤੋਂ ਲਿਆ ਗਿਆ ਅੰਦਾਜ਼ਨ ਸ਼ਹਿਰ ਅਤੇ ਦੇਸ਼, ਬ੍ਰਾਊਜ਼ਰ, ਭਾਸ਼ਾ, ਸਕ੍ਰੀਨ ਆਕਾਰ, ਰੈਫਰਿੰਗ URL, ਲੈਂਡਿੰਗ ਪੰਨਾ ਅਤੇ ਇਸ਼ਤਿਹਾਰ ਮੁਹਿੰਮ ਪੈਰਾਮੀਟਰ। ਇਹ ਸੁਰੱਖਿਆ, ਧੋਖਾਧੜੀ ਰੋਕਥਾਮ ਅਤੇ ਮਾਰਕੀਟਿੰਗ ਐਟ੍ਰਿਬਿਊਸ਼ਨ ਲਈ ਜਾਇਜ਼ ਵਰਤੋਂ ਅਧੀਨ ਪ੍ਰੋਸੈਸ ਹੁੰਦਾ ਹੈ, 90 ਦਿਨ ਰੱਖਿਆ ਜਾਂਦਾ ਹੈ ਅਤੇ ਫਿਰ ਆਪਣੇ-ਆਪ ਮਿਟਾ ਦਿੱਤਾ ਜਾਂਦਾ ਹੈ। Google Analytics 4 ਸਿਰਫ਼ ਕੁੱਲ ਟ੍ਰੈਫਿਕ ਮਾਪਦਾ ਹੈ; IP ਪਤੇ Google ਜਾਂ ਕਿਸੇ ਤੀਜੀ ਧਿਰ ਨੂੰ ਕਦੇ ਨਹੀਂ ਭੇਜੇ ਜਾਂਦੇ। ਇਸ ਡਾਟੇ ਦਾ ਸਾਰ ਲੈਣ ਜਾਂ ਮਿਟਾਉਣ ਲਈ DPO ਨਾਲ ਸੰਪਰਕ ਕਰੋ ਜਾਂ DPDP ਪੋਰਟਲ ਵਰਤੋ।',
  ...
  or: {
    ...
    p7Header: 'ଅନୁଚ୍ଛେଦ VII — ୱେବସାଇଟ୍ ଆନାଲିଟିକ୍ସ, IP ଠିକଣା ଓ ଟ୍ରାଫିକ୍ ଉତ୍ସ ରେକର୍ଡିଂ',
    p7Text: 'ଏହି ୱେବସାଇଟ୍ (ଅନ୍-ପ୍ରିମିସ୍ ShadowVerse ବ୍ୟବସ୍ଥାଠାରୁ ଭିନ୍ନ) ପ୍ରତ୍ୟେକ ପରିଦର୍ଶନ ପାଇଁ ବୈଷୟିକ ସଂଯୋଗ ତଥ୍ୟ ରେକର୍ଡ କରେ: IP ଠିକଣା, ନେଟୱାର୍କ ଅପରେଟର ଓ ASN, ସେଥିରୁ ମିଳୁଥିବା ଆନୁମାନିକ ସହର ଓ ଦେଶ, ବ୍ରାଉଜର୍, ଭାଷା, ସ୍କ୍ରିନ୍ ଆକାର, ରେଫରିଂ URL, ଲ୍ୟାଣ୍ଡିଂ ପେଜ୍ ଓ ବିଜ୍ଞାପନ ଅଭିଯାନ ପାରାମିଟର। ଏହା ସୁରକ୍ଷା, ପ୍ରତାରଣା ପ୍ରତିରୋଧ ଓ ମାର୍କେଟିଂ ଆଟ୍ରିବ୍ୟୁସନ୍ ପାଇଁ ବୈଧ ବ୍ୟବହାର ଅଧୀନରେ ପ୍ରକ୍ରିୟାକୃତ ହୁଏ, 90 ଦିନ ରଖାଯାଏ ଓ ପରେ ସ୍ୱୟଂଚାଳିତ ଭାବେ ବିଲୋପ ହୁଏ। Google Analytics 4 କେବଳ ସାମଗ୍ରିକ ଟ୍ରାଫିକ୍ ମାପେ; IP ଠିକଣା Google କିମ୍ବା ଅନ୍ୟ କୌଣସି ତୃତୀୟ ପକ୍ଷକୁ କେବେ ପଠାଯାଏ ନାହିଁ। ଏହି ତଥ୍ୟର ସାରାଂଶ ପାଇବାକୁ କିମ୍ବା ଲିଭାଇବାକୁ DPO ସହ ଯୋଗାଯୋଗ କରନ୍ତୁ କିମ୍ବା DPDP ପୋର୍ଟାଲ ବ୍ୟବହାର କରନ୍ତୁ।',
  ...
  as: {
    ...
    p7Header: 'অনুচ্ছেদ VII — ৱেবছাইট এনালাইটিক্স, IP ঠিকনা আৰু ট্ৰেফিক উৎস ৰেকৰ্ডিং',
    p7Text: "এই ৱেবছাইটে (অন-প্ৰিমিছ ShadowVerse ব্যৱস্থাৰ পৰা পৃথক) প্ৰতিটো ভ্ৰমণৰ বাবে কাৰিকৰী সংযোগ তথ্য ৰেকৰ্ড কৰে: IP ঠিকনা, নেটৱৰ্ক অপাৰেটৰ আৰু ASN, তাৰ পৰা পোৱা আনুমানিক নগৰ আৰু দেশ, ব্ৰাউজাৰ, ভাষা, স্ক্ৰীনৰ আকাৰ, ৰেফাৰিং URL, লেণ্ডিং পৃষ্ঠা আৰু বিজ্ঞাপন অভিযানৰ পেৰামিটাৰ। ই সুৰক্ষা, প্ৰতাৰণা প্ৰতিৰোধ আৰু বিপণন এট্ৰিবিউচনৰ বাবে বৈধ ব্যৱহাৰৰ অধীনত প্ৰক্ৰিয়াকৰণ কৰা হয়, ৯০ দিন ৰখা হয় আৰু পিছত স্বয়ংক্ৰিয়ভাৱে মচি পেলোৱা হয়। Google Analytics 4 কেৱল সামগ্ৰিক ট্ৰেফিক জোখে; IP ঠিকনা Google বা আন কোনো তৃতীয় পক্ষলৈ কেতিয়াও পঠোৱা নহয়। এই তথ্যৰ সাৰাংশ ল'বলৈ বা মচিবলৈ DPO ৰ সৈতে যোগাযোগ কৰক বা DPDP প'ৰ্টেল ব্যৱহাৰ কৰক।",
  ...
  >
    <div class="industrial-card max-w-3xl w-full border-[#750d37]/60 space-y-4 my-auto max-h-[92vh] sm:max-h-[88vh] flex flex-col p-3.5 sm:p-6 overflow-hidden relative shadow-[0_20px_50px_rgba(0,0,0,0.9)] bg-[#111113]">
      ...
      <div class="space-y-3.5 text-xs md:text-sm text-[#e8e8ea] font-sans leading-relaxed">
        ...
        <div class="p-3.5 bg-[#111113] border border-[#1e1e20] space-y-2">
          <div class="font-mono text-xs font-bold text-white uppercase">{{ currentPrivacyText.p7Header }}</div>
          <p class="text-[#a0a0a4] text-xs leading-relaxed">{{ currentPrivacyText.p7Text }}</p>
        </div>
      </div>
      </div>
