...
const CAMERA_FILTER_KEY = 'shadowverse_camera_filter'

export const useCameraStore = defineStore('camera', () => {
  const cameraFilter = ref<string>(sessionStorage.getItem(CAMERA_FILTER_KEY) || 'ALL')
  ...
  function setFilter(filter: string) {
    ...
    sessionStorage.setItem(CAMERA_FILTER_KEY, filter)
  }
